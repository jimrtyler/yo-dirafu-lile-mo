...
#GUI Variables
$FormTitleText = "Isenkanjade Disiki nipasẹ Jim Tyler (PowerShellEngineer.com)"
$SelectDiskLabelText = "Yan Disk:"
$FreeSpaceLabelText = "Ààyè Ọfẹ (gigabyte):"
$TotalSpaceLabelText = "Apapọ Space (gigabyte):"
$JunkFoundLabelText = "a ri ijekuje (gigabyte):"
$CleanDiskBtnText = "Disk Mọ *Pa awọn faili rẹ*"
$SpaceCleanedLabelText = "Aaye ti a ti sọ di mimọ (gigabyte):"
$LogFileLabelText = "Fáìlì àkówọlé ti rí: $abcdefg"
$CreditLabelText = "Akosile lati ọwọ Jim Tyler - PowerShellEngineer.com"
$LogFileLocatedText = "Fáìlì àkówọlé ti rí"
$AnalyzingDriveText = "Ṣiṣayẹwo Awọn awakọ..."
$BrowsersAreRunningText = "Awọn ẹrọ aṣawakiri nṣiṣẹ... Fi to olumulo leti..."
$PleaseCloseBrowsersText = "Jọwọ pa gbogbo awọn aṣawakiri wẹẹbu rẹ ki o tun gbiyanju lẹẹkansi."
$CleaningDriveText = "Drive Cleaning..."
